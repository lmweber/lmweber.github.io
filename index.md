...
My work in on the development of unsupervised statistical methodology and software for analyzing data from spatial transcriptomics, single-cell RNA sequencing, and other high-throughput genomics technologies. I implement methods as freely available R packages within the open-source [Bioconductor](http://bioconductor.org/) project.
